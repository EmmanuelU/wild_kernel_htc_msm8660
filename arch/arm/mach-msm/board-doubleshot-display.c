...
static struct msm_panel_common_pdata mdp_pdata = {
	...
	.mdp_gamma = doubleshot_mdp_gamma,
};
...
static int doubleshot_lcd_on(struct platform_device *pdev)
{
	...
	switch (panel_type) {
		case PANEL_ID_PYD_SHARP:
			printk(KERN_INFO "doubleshot_lcd_on PANEL_ID_PYD_SHARP\n");
		...
		case PANEL_ID_PYD_AUO_NT:
			printk(KERN_INFO "doubleshot_lcd_on PANEL_ID_PYD_AUO_NT\n");

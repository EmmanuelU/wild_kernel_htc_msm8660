...
#include "board-doubleshot-mmc.h"
#include <mach/mpm.h>
...
static uint32_t wifi_on_gpio_table[] = {
	GPIO_CFG(DOUBLESHOT_GPIO_WIFI_IRQ, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA), 
};

static uint32_t wifi_off_gpio_table[] = {
	GPIO_CFG(DOUBLESHOT_GPIO_WIFI_IRQ, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_4MA), 
};
...
int doubleshot_wifi_power(int on)
{
	...
	mdelay(1);
	gpio_set_value(DOUBLESHOT_GPIO_WIFI_SHUTDOWN_N, on); 

...
static struct msm_gpiomux_config doubleshot_gsbi_configs[] __initdata = {
	{
		.gpio      = 44,		
		.settings = {
...
void __init doubleshot_init_gpiomux(void)
{
	int rc;
	...
	msm_gpiomux_install(doubleshot_gsbi_configs,
			ARRAY_SIZE(doubleshot_gsbi_configs));
}

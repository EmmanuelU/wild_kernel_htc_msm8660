...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
	...
	RPM_LDO(PM8901_L1,  0, 1, 0, 2850000, 3100000, LDO300HMIN),
...
{
	doubleshot_mdp_writeback(msm8x60_reserve_table);
}
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
...
#ifdef CONFIG_LEDS_PM8058
		{
			PM8058_GPIO_PM_TO_SYS(DOUBLESHOT_GREEN_LED),
			{
				.direction		= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{
			PM8058_GPIO_PM_TO_SYS(DOUBLESHOT_AMBER_LED),
			{
				.direction		= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,

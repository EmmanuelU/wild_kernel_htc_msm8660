...
#define S5K3H1GX_TOTAL_STEPS_NEAR_TO_FAR_RAWCHIP_AF                        256 
	...
	struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	if (s5k3h1gx_msm_actuator_info->use_rawchip_af && a_ctrl->af_algo == AF_ALGO_RAWCHIP)
		a_ctrl->set_info.total_steps = S5K3H1GX_TOTAL_STEPS_NEAR_TO_FAR_RAWCHIP_AF;
	else
...
static struct msm_actuator_ctrl_t s5k3h1gx_act_t = {
	...
	.set_info = {
		.total_steps = S5K3H1GX_TOTAL_STEPS_NEAR_TO_FAR_RAWCHIP_AF, 
		.gross_steps = 3,	
		.fine_steps = 1,	
	},
